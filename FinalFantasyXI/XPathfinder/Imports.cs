...
namespace FinalFantasyXI.XPathfinder
{
    /// <summary>
    ...
    public class FFXINAV : IDisposable
    {
        ...
        [DllImport("FFXINAV.dll", EntryPoint = "FindRandomPath", CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool FindRandomPath(IntPtr pFFXINavClassObject, position_t start, float maxRadius,
        ...
        [DllImport("FFXINAV.dll", EntryPoint = "FindPath", CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern void findPath(IntPtr pFFXINavClassObject, position_t start, position_t end,
        ...
        [DllImport("FFXINAV.dll", EntryPoint = "FindClosestPath", CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        public static extern void FindClosestPath(IntPtr pFFXINavClassObject, position_t start, position_t end,
            bool UseCustomNavMesh);
        ...
        [DllImport("FFXINAV.dll", EntryPoint = "EnableNearestPoly", CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool EnableNearestPoly(IntPtr pFFXINavClassObject, position_t Pos, bool Enable,
            bool UseCustomMesh);
        ...
        public unsafe ItemsSafeHandle Get_WayPoints_Wrapper(out double* xitems, out double* zitems, out int itemsCount)
        {
            ...
            if (!Get_WayPoints(this.m_pNativeObject, out itemsHandle, out ItemsSafeHandle itemsHandle2, out xitems,
                out zitems, out itemsCount))
            {
        ...
        public void ChangeNavMeshSettings(double CellSize, double CellHeight, double AgentHeight, double AgentRadius,
            ...
            double DetailSampDistance, double DetailMaxError)
        {
            navMeshSettings(this.m_pNativeObject, CellSize, CellHeight, AgentHeight, AgentRadius, MaxClimb, MaxSlope,
                TileSize,
